...
public class App {
    ...
    private static void runEmpleadoExample() {
        ...
        empleadoContoller.addEmpleados(new Empleado(1, "Ricardo", "DeveLoper"));
        empleadoContoller.addEmpleados(new Empleado(2, "Juan", "DeveLoper"));
        empleadoContoller.addEmpleados(new Empleado(3, "Miguel", "AnyList"));
        empleadoContoller.addEmpleados(new Empleado(4, "Mario", "AnyList"));
